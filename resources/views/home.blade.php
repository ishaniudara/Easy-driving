...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/5.jpg" class="d-block w-100" alt="...">
       <div class="carousel-caption d-none d-md-block">
          <h5 class="animated fadeInRight" style="animation-delay:1s;">WELCOME<h6> To Driving School</h6></h5>
    ...
    <div class="carousel-item">
      <img src="images/1.jpg" class="d-block w-100" alt="...">
       <div class="carousel-caption d-none d-md-block">
          <h5>THE BEST SAFETY MEASURES</h5>
...
<div class="welcome"><h3  class="text-center"style="color: black;">WELCOME TO VIRAJA DRIVING SCHOOL</h3>
<h6  class="text-center"style="color: #1478c4;">"To safety drive<br>with professional instrctors"</h6><p class="text-center">
		...
		<div class="container">
			<div class="row">
				...
				<div class="sociallinks">
					...
					<a href="#" class="googleplus"><i class="fa fa-googleplus"></i></a>
				</div>
